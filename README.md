...
Client side routing ensures crisp, clean, and quick routing from page to page or component to component. With client side routing you are not sending and recieving information between servers via http or https. Routing is kept on the client device and handeled within the client browser.
